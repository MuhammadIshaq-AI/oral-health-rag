        ...
        {STARTER_QUESTIONS.map((q) => (
          <li key={q}>
            <button
              ...
              disabled={disabled}
              onClick={() => onPick(q)}
              className="surface-card-interactive flex min-h-14 w-full items-center gap-3 px-4 py-3 text-left font-medium text-slate-900 disabled:cursor-not-allowed disabled:opacity-60 dark:text-slate-100"
            >
